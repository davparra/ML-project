...
from MobileNetV2 import load_MobileNet
...
model = load_MobileNet(input_shape=IMG_SHAPE, classes=classes, optimizer=optimizer, function=function, verbose=0, trainable=True)
...
checkpoint_path = 'models/MobileNetV2-' + case + '.h5'
